        ...
        while (startAiGame_) {
            ...
            if (move) {
                ...
                if (board_.isWinner(setting_.symbol())) {
                    ...
                    board_.resetBoard();
                    // end
                    outputInformation.messageFromGame(typeMessage::INFO, "\033[1;32m You win! \033[0m", 1500);
                    break;
                }
                ...
                if (board_.isWinner(setting_.getSelectSymbolForAi())) {
                    ...
                    board_.resetBoard();
                    // end
                    outputInformation.messageFromGame(typeMessage::INFO, "\033[1;31m AI win! \033[0m", 3000);
                    break;
                }
            }
